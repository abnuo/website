...
$html = "<h1>$idpos:$id</h1>\n<textarea readonly rows=\"13\" cols=\"60\">" . htmlspecialchars($content) . "</textarea><br>\n<p>Made with <a href=\"https://" . $_SERVER["HTTP_HOST"] . "/paste/share.php?id=oAJiH\">Paste</a>";
$url = file_get_contents('http://tinyurl.com/api-create.php?url='.'data:text/plain;base64,' . base64_encode($html));
